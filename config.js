...
var config = { // NOTE: DO NOT LEAVE ANYTHING BLANK
    ...
    ownerID: '292065674338107393', // Your ID here
    token: 'NDIyNDc4NjQ5OTg0NTQ4ODgz.DfNjbA.cCd05Nr7kMlHZZLO0q7glmN9ecc', // Your bot token here
    ...
    playingGame: 'none.', // The game you want the bot to play. {{prefix}} is replaced with the default prefix below, {{guilds}} is replaced with the guild count and {{version}} is replaced with the bot version. Leave blank to disable
    ...
    dashboard: {
        ...
        oauthSecret: 'I5X0BsyGcNwJ78cvE7V7uNteBcFXrWBK', // The client secret from the Discord bot page
        secure: 'false', // HTTPS: 'true' for true, 'false' for false
        sessionSecret: 'none', // Go crazy on the keyboard here, this is used as a session secret
        domain: 'localhost:3030', // Domain name (with port if not running behind proxy running on port 80). Example: 'domain': 'dashboard.bot-website.com' OR 'domain': 'localhost:33445'
        port: '3030', // The port that it should run on
